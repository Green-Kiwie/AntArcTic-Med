    ...
    <View style={styles.screenContainer}>
      <View style={styles.headerContainer}>
        <View style={styles.headerButtons}>
            ...
            <Button title="Switch It Up" backgroundImage={require('../../assets/images/switchItUp_button.png')}/>
            <Button title="Match It" backgroundImage={require('../../assets/images/matchIt_button.png')}/>
    </View>
  );
};
